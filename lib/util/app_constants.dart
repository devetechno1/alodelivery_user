...
'/api/v1/auth/firebase-reset-password';
  ...
  /// By making [showItemUnderGridSubCat] true, this will show item in category screen under grid sub cat. it always true
  static const bool showItemUnderGridSubCat = true;
  ...
  static const bool showPopularItemsInCategories = true;
